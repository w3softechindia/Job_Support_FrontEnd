...
export class ShareDataService {
  ...
  public freelancerNavBar : header[] = [
    {
      ...
      menu: [
        {
         ...
         {
          menuValue: 'Post a Project',
          route: routes.employee_post_project,
          hasSubRoute: false,
          showSubRoute: false,
          base: 'employer',
          page: 'dashboard',
  ...
  public getFreelancerSideBarData: BehaviorSubject<SideBarData[]> = new BehaviorSubject<
    SideBarData[]
  >(this.freelancerNavBar as unknown as SideBarData[]);

  public getEmployerSideBarData: BehaviorSubject<SideBarData[]> = new BehaviorSubject<
  SideBarData[]
>(this.employerNavBar as unknown as SideBarData[]);
    ...
    },
    {
      ...
      submenu: [
        { title: 'Bookmarked Projects',
         routes: 'freelancer-favourites.html'
         },
        { title: 'Invitations', 
        routes: 'freelancer-invitations.html' 
      },
      ],
    },
    {
